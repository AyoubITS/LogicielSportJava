...
public class UserRegistration extends JFrame {
	...
	/**
	 * crée la frame du formulaire d'inscription
	 */
	...
	public UserRegistration() {
		...
		//recupere les differents imput pour l'inscription
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (err == 0) {
					try {
						//verifie si pseudo existe deja ou pas
						...
						if (x1.next()) {
							JOptionPane.showMessageDialog(btnNewButton, "Pseudo deja pris");
							err = 1;
						}
						connection1.close();
					...
					if (err == 0) {
						...
						try {
							// ajoute a la BDD les informations entrée si le pseudo existe pas deja
